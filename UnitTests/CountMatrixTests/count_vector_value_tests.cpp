...
{
	constexpr count_matrix::count_vector_value default_count_vector_value{};
...
TEST(count_vector_value_test, ctor_with_value)
{
	...
	const count_matrix::count_vector_value count_vector_value(value);
...
{
	size_t value = 0;
	count_matrix::count_vector_value count_vector_value(value);
