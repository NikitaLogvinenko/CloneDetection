...
namespace clone_detection_io
{
	...
	public:
		...
		static void type(
			...
			count_matrix_ns::relative_similarity similarity_threshold);
	...
	private:
		...
		static void type_functions_pair(
			...
			const count_matrix_ns::count_matrices_similarity_data& cm_similarity_data);

		static std::string convert_similarity(count_matrix_ns::relative_similarity relative_similarity);
	...
	inline std::string cm_clone_functions_typer::convert_similarity(
		const count_matrix_ns::relative_similarity relative_similarity)
	{
		...
		count_matrix_ns::relative_similarity similarity_threshold)
	{
			...
			iterator != pairwise_similarity.end(); ++iterator)
		{
			...
			const count_matrix_ns::count_matrices_similarity_data& cm_similarity_data = pairwise_similarity.get_functions_similarity_data(funcs_indices);
			const cpp_code_analysis::func_implementation_info<VarUsageConditionsN>& first_func_info =
