#include "funcs_implementations_info_builder.h"
...
namespace functions_analysis
{
	...
	template <size_t UsageConditionsCount> requires cm::count_vector_length<UsageConditionsCount>
	typename funcs_implementations_info_builder<UsageConditionsCount>::func_info
	funcs_implementations_info_builder<UsageConditionsCount>::construct_func_info(
		func_descriptor func, counters_by_var_descriptor counters_by_vars) const
	{
