...
namespace code_analysis_through_cm
{
	...
	class code_traverser_sharing_units_container_abstract : public code_traverser_abstract<AnalysisTraits>
	{
	public:
	...
	protected:
		code_traverser_sharing_units_container_abstract(std::shared_ptr<translation_units_container> not_traversed_units, 
		...
		{
			const auto method_name = "code_traverser_sharing_units_container_abstract::code_traverser_sharing_units_container_abstract";
