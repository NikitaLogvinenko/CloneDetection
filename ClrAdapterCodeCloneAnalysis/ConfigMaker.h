...
namespace CLR
{
	...
	public:
		...
		//static code_clones_analysis_top_level::cmcd_config makeConfig(System::IO::FileInfo^ inputFileInfo)
		//{
		//	code_clones_analysis_top_level::cmcd_config config;

		//	std::filesystem::path directory = (msclr::interop::marshal_as<std::string>(inputFileInfo->DirectoryName));
