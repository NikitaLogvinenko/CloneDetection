...
class count_vector final
{
	...
	{
	public:
		explicit const_iterator(typename std::array<count_vector_value, Dimension>::const_iterator array_iterator) : std::array<count_vector_value, Dimension>::const_iterator(array_iterator) {}
	};
...
public:
	...
	explicit count_vector(const std::array<count_vector_value, Dimension>& usage_conditions) : conditions_(usage_conditions) {}
