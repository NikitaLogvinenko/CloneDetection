...
namespace clang_c_adaptation
{
	...
	private:
		...
		static CXChildVisitResult visitor_append_subtrees_spellings(CXCursor cursor, CXCursor,
		                                                            CXClientData ptr_to_vector);

		static std::string get_spelling_of_cursor_between_two_children_parts(
			const CXCursor& cursor, CXCursorKind expected_kind);
