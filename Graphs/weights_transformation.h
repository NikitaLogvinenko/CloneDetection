...
namespace graphs
{
	template <class WeightsTransform, class WeightT, class CalculationsT>
	concept weights_transformation = utility::non_const_arithmetic<WeightT> && utility::non_const_integral<CalculationsT>
	&& (std::is_copy_constructible_v<WeightsTransform> || std::is_default_constructible_v<WeightsTransform>)
