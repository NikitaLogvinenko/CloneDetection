...
namespace cpp_code_analysis
{
		...
		const CXClientData func_definitions_cursors_void_ptr)
	{
		...
		if (clang_c_adaptation::cursor_classifier::is_func_definition(cursor_inside_translation_unit))
		{
	...
	{
		if (clang_c_adaptation::cursor_classifier::is_reference_to_var_declaration(cursor_inside_entity))
		{
		...
		const CXClientData var_definition_visit_data_void_ptr)
	{
		...
		if (clang_c_adaptation::cursor_classifier::is_literal(cursor_inside_var_definition))
		{
