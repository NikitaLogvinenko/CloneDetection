...
{
	class var_origin_usage_counter_pair final
	{
	...
	public:
		var_origin_usage_counter_pair() noexcept = default;
		explicit var_origin_usage_counter_pair(const clang_c_adaptation::var_origin origin,
