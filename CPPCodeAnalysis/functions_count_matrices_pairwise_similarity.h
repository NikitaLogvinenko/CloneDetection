...
namespace cpp_code_analysis
{
	...
	public:
		...
		[[nodiscard]] const count_matrix::count_matrices_similarity_data& get_functions_similarity_data(
			const func_indices_pair func_indices_pair) const
		{
			return similarity_data_by_func_indices_pair_.at(func_indices_pair);
		}

		[[nodiscard]] const count_matrix::count_matrices_similarity_data& get_functions_similarity_data_dont_check_indices(
			const func_indices_pair func_indices_pair) const noexcept
		{
